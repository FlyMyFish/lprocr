...
Java_org_opencv_utils_PlateRecognition_InitPlateRecognizer(
...
Java_org_opencv_utils_PlateRecognition_SimpleRecognization(
        JNIEnv *env, jobject obj,
...
Java_org_opencv_utils_PlateRecognition_ReleasePlateRecognizer(JNIEnv *env, jobject obj,
                                                                  jlong object_re) {
