...
public class DeepAssetUtil {
    ...
    private static final String TAG = "DeepAssetUtil";
    ...
    private static void CopyAssets(Context context, String assetDir, String dir) {
        ...
        Log.e(TAG,"mWorkingPath = " + mWorkingPath.getPath());
        ...
        for (String file : files) {
            try {
                ...
                in.close();
                out.close();
                Log.e(TAG,"outFile = " + outFile.getPath());
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
    ...
    public static long initRecognizer(Context context) {
        ...
        Log.e(TAG,"initRecognizer: cascade_filename = " + cascade_filename);
        Log.e(TAG,"initRecognizer: finemapping_prototxt = " + finemapping_prototxt);
        Log.e(TAG,"initRecognizer: finemapping_caffemodel = " + finemapping_caffemodel);
        Log.e(TAG,"initRecognizer: segmentation_prototxt = " + segmentation_prototxt);
        Log.e(TAG,"initRecognizer: segmentation_caffemodel = " + segmentation_caffemodel);
        Log.e(TAG,"initRecognizer: character_prototxt = " + character_prototxt);
        Log.e(TAG,"initRecognizer: character_caffemodel = " + character_caffemodel);
        Log.e(TAG,"initRecognizer: segmentation_free_prototxt = " + segmentation_free_prototxt);
        Log.e(TAG,"initRecognizer: segmentation_free_caffemodel = " + segmentation_free_caffemodel);
