...
import org.opencv.decoding.PlanteImageSource;
...
//      rect.bottom = rect.bottom * cameraResolution.y / screenResolution.y;
     ...
     */
    public Bitmap buildLuminanceSource(byte[] data, int width, int height) {
        //Log.e(TAG, "buildLuminanceSource：data.length = " + data.length);
        Rect rect = getFramingRectInPreview();
        //Log.e(TAG, "getFramingRectInPreview left:" + rect.left + " top:" + rect.top + " width:" + rect.width() + " height:" + rect.height());
        ...
        switch (previewFormat) {
            ...
            case PixelFormat.YCbCr_422_SP:
                return PlanteImageSource.create(data, width, height, rect.left, rect.top, rect.width(), rect.height());
            default:
